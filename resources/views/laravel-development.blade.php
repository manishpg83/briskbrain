        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="our-values">
                        <li>Hiring our team clearly means you are employing a full proof blend of technology, dedication,
                            and expertise.</li>
                        <li>Our pricing might not be the best but is surely competitive enough to astonish you through the
                            quality we deliver</li>
                        <li>Our in-house development and support teams are always ready to help you, and hence you won’t
                            feel stuck dealing with technical issues, bugs, or errors encountered.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>With the help of <b>Laravel PHP framework,</b> we have been able to deliver superior feature rich
                        applications having balanced qualities of exceptional ease and robust features. If you are looking
                        for an agile Laravel Development Company, look no further than us. We deliver sophisticated business
                        solutions taking less processing time, increasing efficiency, and deliver quality output.
                        Laravel has always helped us to achieve rich applications, built within a stipulated time frame,
                        benefitting us to deal with a highly manageable Laravel code. Our acute Laravel developers are ready
                        to implement your complex ideas, converting them to an unimaginable reality, regardless of the
                ...
                <li class="col-6 col-md-4 isotopeSelector business">
                    <div class="inner">
                        <div class="overlay">
                            <h2>Deliverywale</h2>
                            <p>Laravel</p>
                            <a class="galleryItem" href="{{ asset('assets/frontend/img/portfoliyo/deliverywale.webp') }}"><span
