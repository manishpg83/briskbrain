...
<div class="container-fluid px-4 py-4">
    ...
    <div class="mb-4">
        <div class="d-flex align-items-center gap-3 mb-2">
            ...
            <h1 class="fw-bold mb-0">Edit Category</h1>
        </div>
        <p class="text-muted small ms-5 ps-2">Update category details and settings</p>
    </div>
        ...
        <form action="{{ route('admin.category.update', ['category' => $category]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="position-relative">
                            ...
                            <label for="image" 
                                ...
                                <div>
                                    ...
                                    <p class="mb-2">
                                        <span class="fw-semibold text-primary">Click to upload new image</span> 
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="meta_keywords" 
                                  ...
                                  placeholder="Enter keywords separated by commas">{{ old('meta_keywords', $category->meta_keywords) }}</textarea>
                        @error('meta_keywords')
                            <div class="invalid-feedback d-flex align-items-center gap-1">
                                <i class="fas fa-exclamation-circle"></i>
                                {{ $message }}
                            ...
                            <div class="card-body d-flex align-items-center justify-content-between">
                                ...
                                <div class="form-check form-switch form-switch-lg">
                                    <input class="form-check-input" 
                                           ...
                                           id="navbar_status" 
                                           value="1"
                                           {{ old('navbar_status', $category->navbar_status) ? 'checked' : '' }}
            ...
            <div class="px-4 py-3 bg-light border-top">
                <div class="d-flex justify-content-end gap-3">
                    ...
                    <button type="submit" 
                            class="btn btn-lg btn-success shadow submit-btn">
...
{{-- Custom Scripts --}}
<script>
// Auto-generate slug from name (optional for edit, can be disabled)
document.getElementById('name')?.addEventListener('input', function(e) {
    const slugInput = document.getElementById('slug');
    // Only auto-generate if slug is empty or user wants to update it
    if (slugInput && confirm('Do you want to update the slug based on the new name?')) {
...
function removeCurrentImage() {
    if (confirm('Are you sure you want to remove the current image? You need to upload a new one.')) {
        const currentImageDiv = document.getElementById('currentImage').closest('.mb-3');
