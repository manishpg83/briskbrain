...
@section('title', 'Page Metadata Management')
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="mb-4">
        <div class="d-flex align-items-center gap-3 mb-2">
            ...
            <h1 class="fw-bold mb-0">Page Metadata Management</h1>
        </div>
        <p class="text-muted small ms-5 ps-2">Manage SEO and Open Graph metadata for your pages</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.page-metadata.store') }}">
            ...
            <div class="p-4 border-bottom">
                <div class="d-flex align-items-center gap-3 mb-4">
                    ...
                    <h4 class="fw-semibold mb-0">Page Selection</h4>
                </div>

                <div class="row g-4">
                    <div class="col-12">
                        <label for="page_name" class="form-label fw-medium">
                            Select Page <span class="text-danger">*</span>
                        </label>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               name="og_locale" 
                               class="form-control form-control-lg border-2"
                               value="{{ old('og_locale', $pageMetadata->og_locale ?? 'en_US') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               name="og_type" 
                               class="form-control form-control-lg border-2"
                               value="{{ old('og_type', $pageMetadata->og_type ?? 'website') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               name="og_title" 
                               class="form-control form-control-lg border-2"
                               value="{{ old('og_title', $pageMetadata->og_title ?? '') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               name="og_url" 
                               class="form-control form-control-lg border-2"
                               value="{{ old('og_url', $pageMetadata->og_url ?? '') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               name="og_site_name" 
                               class="form-control form-control-lg border-2"
                               value="{{ old('og_site_name', $pageMetadata->og_site_name ?? '') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="og_keywords" 
                                  ...
                                  class="form-control border-2" 
                                  rows="3"
                                  placeholder="Enter Open Graph keywords">{{ old('og_keywords', $pageMetadata->og_keywords ?? '') }}</textarea>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="og_description" 
                                  ...
                                  class="form-control border-2" 
                                  rows="3"
                                  placeholder="Enter Open Graph description">{{ old('og_description', $pageMetadata->og_description ?? '') }}</textarea>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    // Fetch metadata on page load for the first selected page
    var initialPage = $('#page_name').val();
    if (initialPage) {
        fetchMetadata(initialPage);
    }

    // Fetch metadata when page selection changes
    $('#page_name').on('change', function() {
        var selectedPageName = $(this).val();
        fetchMetadata(selectedPageName);
    });

    // Function to fetch metadata
    function fetchMetadata(pageName) {
        $.get('/admin/page-metadata/get-metadata', {
            page_name: pageName
        }, function(data) {
            if (data.metadata) {
                ...
                $('#meta_keywords').val(data.metadata.meta_keywords);
                $('#og_locale').val(data.metadata.og_locale);
                $('#og_type').val(data.metadata.og_type);
                $('#og_title').val(data.metadata.og_title);
                $('#og_description').val(data.metadata.og_description);
                $('#og_keywords').val(data.metadata.og_keywords);
                $('#og_url').val(data.metadata.og_url);
                $('#og_site_name').val(data.metadata.og_site_name);
            } else {
