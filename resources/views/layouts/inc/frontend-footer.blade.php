                ...
                <div class="col-md-4 col-lg-4">
                    <div class="recent-post">
                        ...
                        <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ $setting->logo }}" class="img-logo"
                                alt="BriskBrain Technologies Logo"></a>
                        <div class="connect-outer">
                            <h4>Contact Info</h4>
                            <ul class="contact-sec">
                                <li>
                                    <a href="tel:+91{{ $setting->mobile }}">
                                ...
                                <li class="address-li">
                                    <a href="https://www.google.com/maps/place/BriskBrain+Technologies/@23.113883,72.541279,15z/data=!4m5!3m4!1s0x0:0xde25685d973da59f!8m2!3d23.1138826!4d72.5412793?hl=en" aria-label="Visit our office on Google Maps">
...
<a href="#" class="scroll-top" aria-label="Scroll to top"><i class="fa fa-angle-up" aria-hidden="true"></i></a>
<div class="whatsapp">
        <a href="https://web.whatsapp.com/send?phone=919428889935&amp;text=Hello%20BriskBrain"
            ...
            <img src="{{ asset('assets/frontend/img/whatsapp.svg') }}" alt="WhatsApp Icon"
                width="55" height="55" style="width: 100%; height: 100%;" />
        </a>
</div>
