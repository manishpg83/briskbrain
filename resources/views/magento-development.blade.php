            ...
            <ul class="row portfolio clearfix isotopeContainer">
                ...
                <li class="col-6 col-md-4 isotopeSelector company webapp">
                    <div class="inner">
                        ...
                        <figure><img src="{{ asset('assets/frontend/img/portfoliyo/shopdap.webp') }}" class="img-responsive"
                                alt="shopdap"></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector company">
                ...
                <li class="col-6 col-md-4 isotopeSelector company webapp">
                    <div class="inner">
                        ...
                        <figure><img src="{{ asset('assets/frontend/img/portfoliyo/Fanous.webp') }}" class="img-responsive"
                                alt="Fanous"></figure>
                    </div>
                </li>
                <li class="col-6 col-md-4 isotopeSelector company">
